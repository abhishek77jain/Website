...
function handleFormSubmission(form) {
    ...
    setTimeout(() => {
        ...
        if (formType === 'quote') {
            ...
            window.open(`https://wa.me/919548426821?text=${message}`, '_blank');
        }
    }, 2000);
}
...
function getQuote(productName = '') {
    ...
    window.open(`https://wa.me/919548426821?text=${encodedMessage}`, '_blank');
}

// Call Now Functionality
function callNow() {
    window.location.href = 'tel:+919548426821';
}
